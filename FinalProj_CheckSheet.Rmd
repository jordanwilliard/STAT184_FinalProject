...
(A) .Rmd Line numbers where at least two different data sources are imported: **26 & 27**


(B) .Rmd Line numbers for inspecting data intake: **29 & 30**
...
(A) .Rmd Line number(s) for general data wrangling: **64 & 65**


(B) .Rmd Line number(s) for a join operation: Not used. 


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): **107**


(D) .Rmd Line number(s) for use of regular expressions: **118**


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: **86-94**


(F) .Rmd Line number(s) for use of user-defined functions: Not used. 


(G) .Rmd Line number(s) for use of loops and/or control flow: Not used. 


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): **74 & 76**
...
(A) .Rmd Line number(s) for use of mulitple different geoms: **130 & 131** 

(B) .Rmd Line number(s) for use of multiple aesthetics: **129**

(C) .Rmd Line number(s) for use of layered graphics: Not used.

(D) .Rmd Line number(s) for use of leaflet maps: Not used.

(E) .Rmd Line number(s) for use of decision tree or dendogram results: **154**
...
** GitHub Repo Link: https://github.com/jordanwilliard/STAT184_FinalProject **
