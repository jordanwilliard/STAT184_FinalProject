...
(A) .Rmd Line numbers where at least two different data sources are imported: **25 & 26**


(B) .Rmd Line numbers for inspecting data intake: **28 & 29**
...
(A) .Rmd Line number(s) for general data wrangling: **63 & 64**
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: **86-92**
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): **73 & 75**
