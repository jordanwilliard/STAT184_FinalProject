...
(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): **109**


(D) .Rmd Line number(s) for use of regular expressions: **120**


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: **89-94**
...
(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): **75 & 77**
